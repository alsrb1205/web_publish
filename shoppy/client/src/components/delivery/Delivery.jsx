                ...
                <tbody>
                    ...
                    <tr>
                        <th>취소/반품/교환 안내</th>
                            <td>
                                <ul>
                                    <li>회수지 정보 : 경기도 이천시 경충대로 2610 (중리동) 이천우체국 소포실 ((주)파사드패턴) / (주)파사드패턴</li>
                                    ...
                                    <li>고객센터나 "My Page>주문취소/교환/반품 신청"을 통한 교환/반품 접수 없이 상품을 회수지로 보내실 경우 재발송에 따른 추가 비용이 발생할 수 있으며 경우에 따라서는 교환/반품이 어려울 수 있습니다.</li>
                                    <li><strong>상품하자 이외 사이즈, 색상교환 등 단순 변심에 의한 교환/반품 택배비 고객부담으로 왕복택배비가 발생합니다. (전자상거래 등에서의 소비자보호에 관한 법률 제18조(청약 철회등)9항에 의거 소비자의 사정에 의한 청약 철회 시 택배비는 소비자 부담입니다.)</strong></li>
