...
select * from order_header where left(order_date, 10) between '2019-01-01' and '2019-01-07' order by customer_id asc;
    
-- Q29) 2019-01-01 ~ 2019-01-07 기간 주문의 주문번호, 고객아이디, 사원번호, 주문일시, 소계, 배송비, 전체금액을 조회하세요.
--      단, 전체금액을 기준으로 내림차순 정렬해서 조회하세요.
select * from order_header where left(order_date, 10) between '2019-01-01' and '2019-01-07' order by total_due desc;
...
select * from order_header where left(order_date, 10) between '2019-01-01' and '2019-01-07' order by employee_id asc, order_date desc;
